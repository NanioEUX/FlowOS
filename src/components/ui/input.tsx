    ...
    return (
      <div className="space-y-1">
        ...
        <input
          ...
          id={id}
          className={cn(
            "flex h-10 w-full rounded-lg border border-zinc-300 bg-zinc-50 px-3 py-2 text-sm placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 disabled:opacity-50",
