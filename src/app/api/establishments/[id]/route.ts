...
const SAFE_FIELDS = ["name", "slug", "phone", "email", "address", "logo", "cover", "description", "deliveryFeeType", "deliveryFeeAmount", "deliveryFreeAbove", "paymentConfig", "orderConfig", "primaryColor", "backgroundColor", "textColor", "headerColor", "colorsPublished", "instagramUrl", "businessHours", "loyaltyConfig", "tierConfig", "firstPurchaseEnabled", "firstPurchaseDiscount", "firstPurchaseBonus", "pickupMessage", "deliveryMessage", "confirmationTitle", "confirmationImage", "closedTitle", "closedSub", "tableCount", "defaultTheme", "expenseCategories", "asaasApiKey", "asaasWalletId", "efiClientId", "efiClientSecret", "efiPixKey", "efiCertificate", "efiEnvironment", "efiWebhookToken", "paymentProvider", "interClientId", "interClientSecret", "interCertificate", "interCertificatePassword", "interPixKey", "maxPayOnDeliveryAmount", "blockConcurrentPayOnDelivery", "cancellationBlockEnabled", "cancellationBlockThreshold", "cancellationBlockWindowDays", "cancellationBlockDurationDays", "autoAcceptOrders", "whatsappProvider", "whatsappNumber", "evolutionBaseUrl", "evolutionApiKey", "evolutionInstanceName", "metaPhoneNumberId", "metaAccessToken", "metaWebhookVerifyToken", "metaBusinessAccountId", "metaProfilePictureUrl", "metaUserName", "metaUserPicture", "metaBusinessName", "consumoMarketing", "consumoUtility", "consumoAuthentication", "consumoService", "consumoPeriodo", "metaBillingConfigured", "botEnabled", "botAgentName", "botGreeting", "botMenuOptions", "botUseAI", "botTone", "botFAQ", "botSystemPrompt",
  "botInactivityEnabled", "botInactivityMinutes", "botInactivityMessage",
  "botTransferEnabled", "botTransferKeywords", "botTransferMessage",
  "botTypingDelayMinMs", "botTypingDelayMaxMs",
  ...
  "ifoodEnabled", "ifoodMerchantId", "ifoodMarkupPercent",
