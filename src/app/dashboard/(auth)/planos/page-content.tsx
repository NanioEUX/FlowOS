        ...
        <div className="mb-8 rounded-2xl border border-zinc-200 bg-white p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <button
              ...
              className="flex items-center gap-2 rounded-lg border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100"
            >
            ...
            <div
              ...
              className={`relative flex flex-col rounded-2xl border-2 p-6 transition-all ${
                plan.highlighted
                  ...
                  : "border-zinc-200 bg-white hover:border-white/[.08]"
              }`}
            >
              {plan.badge && (
              ...
              <button
                ...
                className={`flex h-12 items-center justify-center rounded-xl text-sm font-semibold transition-all ${
                  isCurrentPlan
                    ? "bg-green-600/10 text-green-600 cursor-default"
                    : plan.highlighted
