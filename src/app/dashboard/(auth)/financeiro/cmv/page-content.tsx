...
export default function CmvPageContent() {
  ...
  function getSuggestedPrice(productId: string | null, cost: number): number | null {
    if (!productId || cost <= 0) return null
    const cat = productCategoryMap.get(productId)
  ...
  return (
    <div className="space-y-4">
      ...
      {categories.some((c: any) => c.targetMarginPercent != null) && (
        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-2">
            {topProducts.map((p: any, i: number) => {
              ...
              const suggested = getSuggestedPrice(p.productId, unitCost)
              return (
